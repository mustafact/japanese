...
let adjectivesJapanese = "abunai*akai*akarui*amai*anzenna*aoi*atarashii*atatakai*atsui*benrina*chairoi*chiisai*chikai*daijina*damena*fubenna*furui*fushinsetsuna*genkina*hayai*hetana*hikui*himana*hiroi*ii*iroirona*isogashii*itai*joozuna*karai*karui*kiiroi*kiraina*kireina*kitanai*kurai*kuroi*midoriiro*mijikai*murasaki*muzukashii*nagai*nigiyakana*oishii*omoi*omoshiroi*ooi*ookii*osoi*samui*semai*shinsetsuna*shiokarai*shiroi*shitsureina*shizukana*sukanai*sukina*suppai*suzushii*tadashii*takai*tanoshii*teineina*tooi*tsumaranai*tsumetai*wakai*warui*yasashii*yasui*yuumeina"

let adjectivesEnglish = "dangerous*red*bright*sweet*safe*blue*new, fresh*warm*hot*convenient*brown*small*near*important*no good*inconvenient*old*unkind*well, healthy*fast, early*unskillfull*low*free*wide*good*various*busy*painful*skillful*hot, spicy*light*yellow*unlikeable*clean, pretty*dirty*dark*black*green*short*purple*difficult*long*lively*delicious*heavy*interesting*many, much*large*slow, late*cold*narrow*kind*salty*white*rude*quiet*few, a little*likeable*sour*cool*correct*high, expensive*pleasant*polite*far*boring*cold*young*bad*easy*cheap*famous"

let adjectiveForms = "abunai => dangerous*akai => red*akarui => bright*amai => sweet*anzenna => safe*aoi => blue*atarashii => new, fresh*atatakai => warm*atsui => hot*benrina => convenient*chairoi => brown*chiisai => small*chikai => near*daijina => important*damena => no good*fubenna => inconvenient*furui => old*fushinsetsuna => unkind*genkina => well, healthy*hayai => fast, early*hetana => unskillfull*hikui => low*himana => free*hiroi => wide*ii => good*iroirona => various*isogashii => busy*itai => painful*joozuna => skillful*karai => hot, spicy*karui => light*kiiroi => yellow*kiraina => unlikeable*kireina => clean, pretty*kitanai => dirty*kurai => dark*kuroi => black*midoriiro => green*mijikai => short*murasaki => purple*muzukashii => difficult*nagai => long*nigiyakana => lively*oishii => delicious*omoi => heavy*omoshiroi => interesting*ooi => many, much*ookii => large*osoi => slow, late*samui => cold*semai => narrow*shinsetsuna => kind*shiokarai => salty*shiroi => white*shitsureina => rude*shizukana => quiet*sukanai => few, a little*sukina => likeable*suppai => sour*suzushii => cool*tadashii => correct*takai => high, expensive*tanoshii => pleasant*teineina => polite*tooi => far*tsumaranai => boring*tsumetai => cold*wakai => young*warui => bad*yasashii => easy*yasui => cheap*yuumeina => famous"
...
inputArea.addEventListener("input", function(e) {
    ...
    if(e.target.value.toLowerCase() === "adj" ) {
        displayArea.innerHTML = "";
        let forms = adjectiveForms.split("*")
        forms.sort((a,b) => (a > b))
        console.log(forms)
